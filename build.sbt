...
homepage := Some(url("https://github.com/bom4v/data-lake-io"))

startYear := Some(2019)

description := "Delta Lake I/O (in Scala and Python)"

licenses += "Apache-2.0" -> url("https://www.apache.org/licenses/LICENSE-2.0")

scmInfo := Some(
  ScmInfo(
    url("https://github.com/bom4v/data-lake-io"),
    "https://github.com/bom4v/data-lake-io.git"
  )
)
